    ...
    return (
        <div className='flex flex-col items-center bg-[#FFFFFF] w-[1452px]'>
            ...
            <div className="flex px-4 py-3 rounded-md w-[30%] border-2 border-text-secondary-gray mt-4 justify-between">
                ...
                <Image src="/lo3.png" alt="Thumbs Down" className="w-6 h-6 cursor-pointer" width={30} height={24} />
            </div>
            <div className="grid grid-cols-12 px-8 md:px-16 py-8 bg-[#ffffff] text-[#111111]">
                    ...
                    <div>
                        ...
                        <div className="mb-6 text-[#111111]">
                            ...
                            <div className="flex space-x-2">
                                <Image src="/lo5.png" alt="Thumbs Down" className="w-6 h-6 cursor-pointer" width={24} height={24} />
                                <Image src="/lo4.png" alt="Thumbs Down" className="w-6 h-6 cursor-pointer" width={24} height={24} />
                            </div>
                        </div>
                ...
                <div className='col-span-3'>
                    ...
                    <div className="flex flex-col items-center space-y-2 text-center">
                        <Image src="/lo6.png" alt='Phone' height={64} width={64} />
                    ...
                    {/* Chat Section */}
                    <div className="flex flex-col items-center space-y-2 text-center">
                        <Image src="/lo7.png" alt="Thumbs Down" className="w-[64px] h-[64px] cursor-pointer" width={64} height={64} />
                    ...
                    {/* Email Section */}
                    <div className="flex flex-col items-center space-y-2 text-center">
                        <Image src="/lo8.png" alt="Thumbs Down" className="w-[64px] h-[64px] cursor-pointer" width={64} height={64} />
                    ...
                    <div className="flex flex-col items-center space-y-2 text-center">
                        ...
                        <Image src="/lo9.png" alt="Thumbs Down" className="w-[64px] h-[64px] cursor-pointer" width={64} height={64} />
